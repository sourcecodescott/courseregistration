...
public class ResetPasswordEspressoTest {
    ...
    @Test
    public void resetPasswordEspressoTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.txtUsername),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("bobsimpson"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.btn_password_reset), withText("Password Reset"),
                        childAtPosition(
                                allOf(withId(R.id.b4container),
                                        childAtPosition(
